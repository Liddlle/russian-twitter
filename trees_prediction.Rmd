...
twitter.coded$clean <- str_replace(twitter.coded$clean , "@[[:word:]]+", "USERID") #заменить mentions
twitter.coded$clean <- str_replace(twitter.coded$clean , "http[[:graph:]]+", "LINK") #заменить mentions
