...
twitter.coded <- filter(twitter.coded, life_stage != "n/a" & life_stage != "студент/ работающий" & life_stage != "школьник/студент"  & life_stage != "учащийся" ) %>% factor(twitter.coded$life_stage) %>% droplevels() %>% forcats::fct_collapse(работающий = c("работающий","работаюший", "рабочий", "раотающий"), школьник = c("школьник", "школьница"))
